...
const POTA: Producto[] = [
  ...
  { id: 'alas',        nombre: 'Alas de Pota',            nombreEN: 'Giant Squid Wings',         cientifico: 'Dosidicus gigas', descripcion: 'Textura firme y sabor intenso. Alta demanda en mercados españoles y coreanos.', imagen: '/recursos/tentaculo_pota_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'principal' },
  ...
  { id: 'reproductor', nombre: 'Reproductor',             nombreEN: 'Sexual Tentacle',           cientifico: 'Dosidicus gigas', descripcion: 'Corte especializado con alta valorización en mercados asiáticos.', imagen: '/recursos/tentaculo_pota_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'principal' },
  { id: 'nucas',       nombre: 'Nucas de Pota',           nombreEN: 'Giant Squid Necks',         cientifico: 'Dosidicus gigas', descripcion: 'Parte dorsal con músculo de alta proteína. Presentado en bloques.', imagen: '/recursos/pota_industrial_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'principal' },
  // SUBPRODUCTOS
  { id: 'membrana',    nombre: 'Membrana',                nombreEN: 'Membrane',                  cientifico: 'Dosidicus gigas', descripcion: 'Subproducto de alto rendimiento para mercados industriales.', imagen: '/recursos/pota_industrial_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'subproducto' },
  { id: 'membranaCoc', nombre: 'Membrana Cocida',         nombreEN: 'Boiled Membrane',           cientifico: 'Dosidicus gigas', descripcion: 'Procesada en planta bajo estrictos controles HACCP.', imagen: '/recursos/pota_industrial_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'subproducto' },
  { id: 'telilla',     nombre: 'Telilla',                 nombreEN: 'Belly',                     cientifico: 'Dosidicus gigas', descripcion: 'Capa interna gelatinosa. Uso industrial en Asia.', imagen: '/recursos/pota_industrial_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'subproducto' },
  { id: 'telillaCoc',  nombre: 'Telilla Cocida',          nombreEN: 'Boiled Belly',              cientifico: 'Dosidicus gigas', descripcion: 'Proceso térmico controlado para eliminar riesgo microbiológico.', imagen: '/recursos/pota_industrial_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'subproducto' },
  { id: 'pico',        nombre: 'Pico (Boca)',             nombreEN: 'Mouth / Beak',              cientifico: 'Dosidicus gigas', descripcion: 'Subproducto de uso industrial con alta demanda en China.', imagen: '/recursos/pota_industrial_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'subproducto' },
  { id: 'ventosa',     nombre: 'Ventosas',                nombreEN: 'Suckers',                   cientifico: 'Dosidicus gigas', descripcion: 'Uso culinario en Asia Oriental. Textura crujiente apreciada.', imagen: '/recursos/tentaculo_pota_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'subproducto' },
  { id: 'recortes',    nombre: 'Recortes',                nombreEN: 'Bits & Pieces',             cientifico: 'Dosidicus gigas', descripcion: 'Trozos irregulares de alta proteína para procesadores de surimi.', imagen: '/recursos/pota_industrial_premium.png', formatos: [FMT.IQF, FMT.BLOCK], subSeccion: 'subproducto' },
  { id: 'recortesCoc', nombre: 'Recorte Precocido',       nombreEN: 'Boiled Bits & Pieces',      cientifico: 'Dosidicus gigas', descripcion: 'Tratamiento térmico completo. Reducción enzimática garantizada.', imagen: '/recursos/pota_industrial_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'subproducto' },
  // VALOR AGREGADO
  { id: 'daruma',      nombre: 'Daruma Cocida',           nombreEN: 'Boiled Fillet (Daruma)',    cientifico: 'Dosidicus gigas', descripcion: 'Filete cocido y laminado tipo japonés. Producto estrella de exportación a Japón.', imagen: '/recursos/filete_pota_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'valorAgregado' },
  { id: 'anillas',     nombre: 'Anillas de Pota',         nombreEN: 'Squid Rings',               cientifico: 'Dosidicus gigas', descripcion: 'Corte transversal uniforme ideal para calamares a la romana. Mercado europeo.', imagen: '/recursos/tentaculo_pota_premium.png', formatos: [FMT.BLOCK, FMT.IQF], subSeccion: 'valorAgregado' },
  { id: 'alasCoc',     nombre: 'Alas Cocidas',            nombreEN: 'Boiled Wings',              cientifico: 'Dosidicus gigas', descripcion: 'Wings procesadas por cocción al vapor. Listas para marinar o servir.', imagen: '/recursos/tentaculo_pota_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'valorAgregado' },
  { id: 'labios',      nombre: 'Labios de Pota',          nombreEN: 'Squid Lips',                cientifico: 'Dosidicus gigas', descripcion: 'Producto inusual de alta valorización en gastronomía asiática de vanguardia.', imagen: '/recursos/tentaculo_pota_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'valorAgregado' },
  { id: 'cono',        nombre: 'Cono de Pota',            nombreEN: 'Squid Cone',                cientifico: 'Dosidicus gigas', descripcion: 'Sifón completo ideal para relleno. Alta demanda en España.', imagen: '/recursos/tentaculo_pota_premium.png', formatos: [FMT.BLOCK],           subSeccion: 'valorAgregado' },
  { id: 'botones',     nombre: 'Botones de Pota',         nombreEN: 'Squid Buttons',             cientifico: 'Dosidicus gigas', descripcion: 'Porciones circulares de tamaño uniforme. Producto para foodservice y retail.', imagen: '/recursos/pota_industrial_premium.png', formatos: [FMT.BLOCK, FMT.IQF], subSeccion: 'valorAgregado' },
  { id: 'rabas',       nombre: 'Rabas de Pota',           nombreEN: 'Squid Strips (Rabas)',      cientifico: 'Dosidicus gigas', descripcion: 'Tiras longitudinales empanizables. El producto de mayor crecimiento en mercados latinoeuropeos.', imagen: '/recursos/filete_pota_premium.png', formatos: [FMT.BLOCK, FMT.IQF], subSeccion: 'valorAgregado' },
]
...
const PECES: Producto[] = [
  ...
  { id: 'pejerrey',  nombre: 'Pejerrey',             nombreEN: 'Silverside',          cientifico: 'Odontesthes regia regia',     descripcion: 'Especie artesanal del litoral peruano. Carne blanca y firme. Base de la gastronomía costeña peruana.', imagen: '/recursos/merluza_premium.png', formatos: [FMT.IQF, FMT.BLOCK] },
  { id: 'bonito',    nombre: 'Bonito',               nombreEN: 'Pacific Bonito',      cientifico: 'Sarda chiliensis',            descripcion: 'Túnido de aguas frías del Perú. Carne oscura y robusta ideal para conservas y mercados asiáticos.', imagen: '/recursos/mahi_mahi_premium.png', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'anchoveta', nombre: 'Anchoveta',            nombreEN: 'Peruvian Anchovy',    cientifico: 'Engraulis ringens',           descripcion: 'La especie más abundante del Pacífico sur. Base de la cadena trófica marina y de la industria harinera.', imagen: '/recursos/merluza_premium.png', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'jurel',     nombre: 'Jurel',                nombreEN: 'Horse Mackerel',      cientifico: 'Trachurus murphyi',           descripcion: 'Pelágico de alta productividad. Exportado principalmente a mercados africanos y del este europeo.', imagen: '/recursos/mahi_mahi_premium.png', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'caballa',   nombre: 'Caballa',              nombreEN: 'Mackerel',            cientifico: 'Scomber japonicus',           descripcion: 'Alto contenido en Omega-3. Ideal para conservas y filetes ahumados. Exportado entero o en filetes.', imagen: '/recursos/mahi_mahi_premium.png', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'chiri',     nombre: 'Chiri',                nombreEN: 'Pacific Butterfish',  cientifico: 'Peprilus medius',             descripcion: 'Carne suave y de fácil digestión. Alta demanda en mercados asiáticos por su sabor neutro y textura delicada.', imagen: '/recursos/merluza_premium.png', formatos: [FMT.BLOCK, FMT.IQF] },
]
...
const MARISCOS: Producto[] = [
  ...
  { id: 'calamar',       nombre: 'Calamar del Pacífico',      nombreEN: 'Pacific Squid',            cientifico: 'Loligo spp.',                       descripcion: 'Especie de talla menor que la pota. Textura más fina y terneza superior. Exportado a España y EE.UU.', imagen: '/recursos/tentaculo_pota_premium.png', formatos: [FMT.BLOCK, FMT.IQF] },
]
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
                      <motion.div variants={fadeUp} style={{ position: 'relative', flex: '1 1 320px', aspectRatio: '1', overflow: 'hidden', minHeight: '280px' }}>
                        <Image src="/recursos/product_squid.png" alt="Calamar Gigante Pota" fill style={{ objectFit: 'contain', padding: '2.5rem' }} priority sizes="(max-width:1024px) 100vw, 50vw" />
