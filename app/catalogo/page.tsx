...
const POTA: Producto[] = [
  // PRINCIPALES
  { id: 'filete',      nombre: 'Filete de Pota',          nombreEN: 'Giant Squid Fillet',        cientifico: 'Dosidicus gigas', descripcion: 'Filete premium limpio y calibrado. El corte más comercializado en mercados asiáticos y europeos.', imagen: STORAGE_URL + 'filete_pota_premium.webp', formatos: [FMT.BLOCK],           subSeccion: 'principal', destacado: true },
  { id: 'alas',        nombre: 'Alas de Pota',            nombreEN: 'Giant Squid Wings',         cientifico: 'Dosidicus gigas', descripcion: 'Textura firme y sabor intenso. Alta demanda en mercados españoles y coreanos.', imagen: STORAGE_URL + 'ala.webp', formatos: [FMT.BLOCK],           subSeccion: 'principal' },
  { id: 'tentaculos',  nombre: 'Tentáculos de Pota',      nombreEN: 'Giant Squid Tentacles',     cientifico: 'Dosidicus gigas', descripcion: 'Presentación entera. Mercado objetivo: España, Portugal y Japón.', imagen: STORAGE_URL + 'tentaculo.webp', formatos: [FMT.BLOCK],           subSeccion: 'principal' },
  { id: 'reproductor', nombre: 'Reproductor',             nombreEN: 'Sexual Tentacle',           cientifico: 'Dosidicus gigas', descripcion: 'Corte especializado con alta valorización en mercados asiáticos.', imagen: STORAGE_URL + 'reproductor.webp', formatos: [FMT.BLOCK],           subSeccion: 'principal' },
  { id: 'nucas',       nombre: 'Nucas de Pota',           nombreEN: 'Giant Squid Necks',         cientifico: 'Dosidicus gigas', descripcion: 'Parte dorsal con músculo de alta proteína. Presentado en bloques.', imagen: STORAGE_URL + 'nuca.webp', formatos: [FMT.BLOCK],           subSeccion: 'principal' },
  // SUBPRODUCTOS
  { id: 'membrana',    nombre: 'Membrana',                nombreEN: 'Membrane',                  cientifico: 'Dosidicus gigas', descripcion: 'Subproducto de alto rendimiento para mercados industriales.', imagen: STORAGE_URL + 'mebrana.webp', formatos: [FMT.BLOCK],           subSeccion: 'subproducto' },
  { id: 'membranaCoc', nombre: 'Membrana Cocida',         nombreEN: 'Boiled Membrane',           cientifico: 'Dosidicus gigas', descripcion: 'Procesada en planta bajo estrictos controles HACCP.', imagen: STORAGE_URL + 'membrana cocida.webp', formatos: [FMT.BLOCK],           subSeccion: 'subproducto' },
  ...
  { id: 'pico',        nombre: 'Pico (Boca)',             nombreEN: 'Mouth / Beak',              cientifico: 'Dosidicus gigas', descripcion: 'Subproducto de uso industrial con alta demanda en China.', imagen: STORAGE_URL + 'pico.webp', formatos: [FMT.BLOCK],           subSeccion: 'subproducto' },
  { id: 'ventosa',     nombre: 'Ventosas',                nombreEN: 'Suckers',                   cientifico: 'Dosidicus gigas', descripcion: 'Uso culinario en Asia Oriental. Textura crujiente apreciada.', imagen: STORAGE_URL + 'tentaculo4.webp', formatos: [FMT.BLOCK],           subSeccion: 'subproducto' },
  { id: 'recortes',    nombre: 'Recortes',                nombreEN: 'Bits & Pieces',             cientifico: 'Dosidicus gigas', descripcion: 'Trozos irregulares de alta proteína para procesadores de surimi.', imagen: STORAGE_URL + 'recortes.webp', formatos: [FMT.IQF, FMT.BLOCK], subSeccion: 'subproducto' },
  { id: 'recortesCoc', nombre: 'Recorte Precocido',       nombreEN: 'Boiled Bits & Pieces',      cientifico: 'Dosidicus gigas', descripcion: 'Tratamiento térmico completo. Reducción enzimática garantizada.', imagen: STORAGE_URL + 'recorte-pre.webp', formatos: [FMT.BLOCK],           subSeccion: 'subproducto' },
  // VALOR AGREGADO
  { id: 'daruma',      nombre: 'Daruma Cocida',           nombreEN: 'Boiled Fillet (Daruma)',    cientifico: 'Dosidicus gigas', descripcion: 'Filete cocido y laminado tipo japonés. Producto estrella de exportación a Japón.', imagen: STORAGE_URL + 'daruma cocida.webp', formatos: [FMT.BLOCK],           subSeccion: 'valorAgregado' },
  { id: 'anillas',     nombre: 'Anillas de Pota',         nombreEN: 'Squid Rings',               cientifico: 'Dosidicus gigas', descripcion: 'Corte transversal uniforme ideal para calamares a la romana. Mercado europeo.', imagen: STORAGE_URL + 'anillas.webp', formatos: [FMT.BLOCK, FMT.IQF], subSeccion: 'valorAgregado' },
  { id: 'alasCoc',     nombre: 'Alas Cocidas',            nombreEN: 'Boiled Wings',              cientifico: 'Dosidicus gigas', descripcion: 'Wings procesadas por cocción al vapor. Listas para marinar o servir.', imagen: STORAGE_URL + 'ala-co.webp', formatos: [FMT.BLOCK],           subSeccion: 'valorAgregado' },
  ...
  { id: 'cono',        nombre: 'Cono de Pota',            nombreEN: 'Squid Cone',                cientifico: 'Dosidicus gigas', descripcion: 'Sifón completo ideal para relleno. Alta demanda en España.', imagen: STORAGE_URL + 'cono.webp', formatos: [FMT.BLOCK],           subSeccion: 'valorAgregado' },
  ...
  { id: 'rabas',       nombre: 'Rabas de Pota',           nombreEN: 'Squid Strips (Rabas)',      cientifico: 'Dosidicus gigas', descripcion: 'Tiras longitudinales empanizables. El producto de mayor crecimiento en mercados latinoeuropeos.', imagen: STORAGE_URL + 'rabas.webp', formatos: [FMT.BLOCK, FMT.IQF], subSeccion: 'valorAgregado' },
]

const PECES: Producto[] = [
  { id: 'merluza',   nombre: 'Merluza Peruana',      nombreEN: 'Peruvian Hake',       cientifico: 'Merluccius gayi peruanus',   descripcion: 'Especie de alta valorización en mercados europeos. Filetes blancos, sin espinas, de textura suave y delicada.', imagen: STORAGE_URL + 'merluza_premium.webp', formatos: [FMT.IQF, FMT.BLOCK, FMT.IWP] },
  { id: 'perico',    nombre: 'Perico / Mahi Mahi',   nombreEN: 'Mahi Mahi',           cientifico: 'Coryphaena hippurus',         descripcion: 'Pesca de temporada del Pacífico sur peruano. Alta valorización en EEUU y Asia. Sabor suave y versátil.', imagen: STORAGE_URL + 'mahi_mahi_premium.webp', formatos: [FMT.IQF, FMT.IWP, FMT.IVP] },
  { id: 'pejerrey',  nombre: 'Pejerrey',             nombreEN: 'Silverside',          cientifico: 'Odontesthes regia regia',     descripcion: 'Especie artesanal del litoral peruano. Carne blanca y firme. Base de la gastronomía costeña peruana.', imagen: STORAGE_URL + 'merluza_premium.webp', formatos: [FMT.IQF, FMT.BLOCK] },
  { id: 'bonito',    nombre: 'Bonito',               nombreEN: 'Pacific Bonito',      cientifico: 'Sarda chiliensis',            descripcion: 'Túnido de aguas frías del Perú. Carne oscura y robusta ideal para conservas y mercados asiáticos.', imagen: STORAGE_URL + 'mahi_mahi_premium.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'anchoveta', nombre: 'Anchoveta',            nombreEN: 'Peruvian Anchovy',    cientifico: 'Engraulis ringens',           descripcion: 'La especie más abundante del Pacífico sur. Base de la cadena trófica marina y de la industria harinera.', imagen: STORAGE_URL + 'merluza_premium.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'jurel',     nombre: 'Jurel',                nombreEN: 'Horse Mackerel',      cientifico: 'Trachurus murphyi',           descripcion: 'Pelágico de alta productividad. Exportado principalmente a mercados africanos y del este europeo.', imagen: STORAGE_URL + 'mahi_mahi_premium.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'caballa',   nombre: 'Caballa',              nombreEN: 'Mackerel',            cientifico: 'Scomber japonicus',           descripcion: 'Alto contenido en Omega-3. Ideal para conservas y filetes ahumados. Exportado entero o en filetes.', imagen: STORAGE_URL + 'mahi_mahi_premium.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'chiri',     nombre: 'Chiri',                nombreEN: 'Pacific Butterfish',  cientifico: 'Peprilus medius',             descripcion: 'Carne suave y de fácil digestión. Alta demanda en mercados asiáticos por su sabor neutro y textura delicada.', imagen: STORAGE_URL + 'merluza_premium.webp', formatos: [FMT.BLOCK, FMT.IQF] },
]

const MARISCOS: Producto[] = [
  { id: 'pulpo',         nombre: 'Pulpo del Pacífico',        nombreEN: 'Pacific Octopus',          cientifico: 'Octopus spp.',                     descripcion: 'Capturado por pesquería artesanal. Cocido y limpiado en planta. Alta demanda en España, Japón y Corea.', imagen: STORAGE_URL + 'pulpo_premium.webp',      formatos: [FMT.BLOCK, FMT.SKIN_PACK, FMT.TRAY, FMT.BAGS] },
  { id: 'langostinoCal', nombre: 'Langostino Californiensis', nombreEN: 'California Brown Shrimp',  cientifico: 'Farfantepenaeus californiensis',    descripcion: 'Camarón salvaje del norte peruano. Sabor intenso y dulce. Ruto hacia España, Italia y EE.UU.', imagen: STORAGE_URL + 'langostino_premium.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'langostinoBlc', nombre: 'Langostino Blanco',         nombreEN: 'White Shrimp',             cientifico: 'Litopenaeus vannamei',              descripcion: 'De acuicultura certificada. Consistencia uniforme y sabor neutro ideal para mercados de foodservice global.', imagen: STORAGE_URL + 'langostino_premium.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'gambon',        nombre: 'Gambón Argentino',          nombreEN: 'Argentine Red Shrimp',     cientifico: 'Pleoticus muelleri',                descripcion: 'Captura silvestre en el Atlántico Sur. Dulzor superior y color rojo intenso que lo diferencia en el mercado premium.', imagen: STORAGE_URL + 'langostino_premium.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'concha',        nombre: 'Concha de Abanico',         nombreEN: 'Peruvian Scallop',         cientifico: 'Argopecten purpuratus',             descripcion: 'La joya de la acuicultura peruana. Cultivada en la bahía de Sechura. Textura mantecosa y perfil de sabor dulce.', imagen: STORAGE_URL + 'concha_premium.webp',     formatos: [FMT.IQF] },
  { id: 'calamar',       nombre: 'Calamar del Pacífico',      nombreEN: 'Pacific Squid',            cientifico: 'Loligo spp.',                       descripcion: 'Especie de talla menor que la pota. Textura más fina y terneza superior. Exportado a España y EE.UU.', imagen: STORAGE_URL + 'tentaculo_pota_premium.webp', formatos: [FMT.BLOCK, FMT.IQF] },
]
  ...
  return (
    <>
      ...
      <main style={{ minHeight: '100vh', background: '#0A0F1F', color: '#fff', paddingTop: `${NAVBAR_H}px` }}>
        ...
        {/* ═══ HERO ═══ */}
        <section style={{ padding: '6rem 0', position: 'relative', overflow: 'hidden', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
