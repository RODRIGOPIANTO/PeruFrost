...
const POTA: Producto[] = [
  ...
  { id: 'nucas', nombre: 'Nucas de Pota', nombreEN: 'Giant Squid Necks', cientifico: 'Dosidicus gigas', descripcion: 'Parte dorsal con músculo de alta proteína. Presentado en bloques.', imagen: STORAGE_URL + 'nuca2.webp', formatos: [FMT.BLOCK], subSeccion: 'principal' },
  // SUBPRODUCTOS
...
const PECES: Producto[] = [
  { id: 'merluza', nombre: 'Merluza Peruana', nombreEN: 'Peruvian Hake', cientifico: 'Merluccius gayi peruanus', descripcion: 'Especie de alta valorización en mercados europeos. Filetes blancos, sin espinas, de textura suave y delicada.', imagen: STORAGE_URL + 'merluza-1.webp', formatos: [FMT.IQF, FMT.BLOCK, FMT.IWP] },
  { id: 'perico', nombre: 'Perico / Mahi Mahi', nombreEN: 'Mahi Mahi', cientifico: 'Coryphaena hippurus', descripcion: 'Pesca de temporada del Pacífico sur peruano. Alta valorización en EEUU y Asia. Sabor suave y versátil.', imagen: STORAGE_URL + 'perico-1.webp', formatos: [FMT.IQF, FMT.IWP, FMT.IVP] },
  { id: 'pejerrey', nombre: 'Pejerrey', nombreEN: 'Silverside', cientifico: 'Odontesthes regia regia', descripcion: 'Especie artesanal del litoral peruano. Carne blanca y firme. Base de la gastronomía costeña peruana.', imagen: STORAGE_URL + 'pejerrey-1.webp', formatos: [FMT.IQF, FMT.BLOCK] },
  { id: 'anchoveta', nombre: 'Anchoveta', nombreEN: 'Peruvian Anchovy', cientifico: 'Engraulis ringens', descripcion: 'La especie más abundante del Pacífico sur. Base de la cadena trófica marina y de la industria harinera.', imagen: STORAGE_URL + 'anchoveta.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'bonito', nombre: 'Bonito', nombreEN: 'Pacific Bonito', cientifico: 'Sarda chiliensis', descripcion: 'Túnido de aguas frías del Perú. Carne oscura y robusta ideal para conservas y mercados asiáticos.', imagen: STORAGE_URL + 'bonito.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'jurel', nombre: 'Jurel', nombreEN: 'Horse Mackerel', cientifico: 'Trachurus murphyi', descripcion: 'Pelágico de alta productividad. Exportado principalmente a mercados africanos y del este europeo.', imagen: STORAGE_URL + 'jurel.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'caballa', nombre: 'Caballa', nombreEN: 'Mackerel', cientifico: 'Scomber japonicus', descripcion: 'Alto contenido en Omega-3. Ideal para conservas y filetes ahumados. Exportado entero o en filetes.', imagen: STORAGE_URL + 'caballa.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'chiri', nombre: 'Chiri', nombreEN: 'Pacific Butterfish', cientifico: 'Peprilus medius', descripcion: 'Carne suave y de fácil digestión. Alta demanda en mercados asiáticos por su sabor neutro y textura delicada.', imagen: STORAGE_URL + 'chiri.webp', formatos: [FMT.BLOCK, FMT.IQF] },
]
...
const MARISCOS: Producto[] = [
  ...
  { id: 'langostinoCal', nombre: 'Langostino Californiensis', nombreEN: 'California Brown Shrimp', cientifico: 'Farfantepenaeus californiensis', descripcion: 'Camarón salvaje del norte peruano. Sabor intenso y dulce. Ruto hacia España, Italia y EE.UU.', imagen: STORAGE_URL + 'langostinos-1.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'langostinoBlc', nombre: 'Langostino Blanco', nombreEN: 'White Shrimp', cientifico: 'Litopenaeus vannamei', descripcion: 'De acuicultura certificada. Consistencia uniforme y sabor neutro ideal para mercados de foodservice global.', imagen: STORAGE_URL + 'langostinos-1.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'gambon', nombre: 'Gambón Argentino', nombreEN: 'Argentine Red Shrimp', cientifico: 'Pleoticus muelleri', descripcion: 'Captura silvestre en el Atlántico Sur. Dulzor superior y color rojo intenso que lo diferencia en el mercado premium.', imagen: STORAGE_URL + 'langostinos-1.webp', formatos: [FMT.BLOCK, FMT.IQF] },
  { id: 'concha', nombre: 'Concha de Abanico', nombreEN: 'Peruvian Scallop', cientifico: 'Argopecten purpuratus', descripcion: 'La joya de la acuicultura peruana. Cultivada en la bahía de Sechura. Textura mantecosa y perfil de sabor dulce.', imagen: STORAGE_URL + 'conchas-de-abanico-1.webp', formatos: [FMT.IQF] },
  { id: 'calamar', nombre: 'Calamar del Pacífico', nombreEN: 'Pacific Squid', cientifico: 'Loligo spp.', descripcion: 'Especie de talla menor que la pota. Textura más fina y terneza superior. Exportado a España y EE.UU.', imagen: STORAGE_URL + 'calamar-1.webp', formatos: [FMT.BLOCK, FMT.IQF] },
]
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
                      ...
                      <motion.div variants={fadeUp} style={{ flex: '1 1 320px', padding: '3rem' }}>
                        ...
                        <p style={{ color: '#8BA0B4', fontSize: '1.05rem', lineHeight: 1.75, marginBottom: '2rem', maxWidth: '500px' }}>
                          {lang === 'es'
                            ? 'Capturada en las aguas peruanas. El calamar más grande del Pacífico sur. Procesado bajo estricta cadena de frío en nuestra planta certificada BRCGS AA en Paita.'
                            : 'Caught in Peruvian waters. The largest squid in the South Pacific. Processed under a strict cold chain in our BRCGS AA certified plant in Paita.'}
                        </p>
