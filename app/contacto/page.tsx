  ...
  const contactItems = [
    {
      ...
      note: lang === 'es' ? 'Respuesta en < 24h hÃ¡biles' : 'Reply within 24h',
    },
    {
      icon: <Phone size={24} />, label: lang === 'es' ? 'LÃ­nea de Ventas' : 'Sales Line',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
                ...
                <div>
                  <h2 style={{ fontFamily: "'Inter Tight', sans-serif", fontWeight: 800, fontSize: '1.5rem', marginBottom: '1.5rem', color: '#fff' }}>
                    {lang === 'es' ? 'Sedes PerÃº Frost' : 'PerÃº Frost HQ'}
                  </h2>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '1.25rem', background: 'rgba(0,229,255,0.04)', border: '1px solid rgba(0,229,255,0.15)', borderRadius: '16px', padding: '1.25rem', alignItems: 'center', transition: 'border-color 0.2s', cursor: 'pointer' }}>
                      ...
                      <div>
                        ...
                        <h3 style={{ fontFamily: "'Inter Tight', sans-serif", fontWeight: 800, fontSize: '1.1rem', color: '#fff', marginBottom: '0.25rem' }}>Paita, Piura (PerÃº)</h3>
                        <p style={{ color: '#8BA0B4', fontSize: '0.85rem' }}>Jr. Los Pescadores NÂº 946. Zona Industrial 1.</p>
                      </div>
                     </div>
                    </a>
                    {/* Lima */}
                    <div style={{ display: 'flex', gap: '1.25rem', background: 'rgba(26,34,56,0.5)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: '1.25rem', alignItems: 'center' }}>
                      ...
                      <div>
                        ...
                        <p style={{ color: '#8BA0B4', fontSize: '0.85rem' }}>Av. Manuel OlguÃ­n NÂº 501. Santiago de Surco.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                     ...
                     <h2 style={{ fontFamily: "'Inter Tight', sans-serif", fontWeight: 800, fontSize: '2rem', color: '#fff', lineHeight: 1.1 }}>
                       {lang === 'es' ? 'Â¿Listo para cotizar?' : 'Ready to quote?'}
                     </h2>
                     <p style={{ color: '#8BA0B4', fontSize: '1.05rem', lineHeight: 1.8 }}>
                       {lang === 'es' 
                         ? 'EscrÃ­banos directamente a nuestro correo de ventas. Nos encargaremos de procesar su solicitud, confirmar stock, capacidad de producciÃ³n y preparar su proforma CIF/FOB en tiempo rÃ©cord.'
                     ...
                     <div style={{ padding: '1.5rem', background: 'rgba(0,229,255,0.06)', borderRadius: '16px', border: '1px dashed rgba(0,229,255,0.3)' }}>
                       ...
                       <ul style={{ color: '#fff', fontSize: '0.9rem', paddingLeft: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                         <li>{lang === 'es' ? 'Producto (y nombre cientÃ­fico si aplica)' : 'Product (and scientific name if applicable)'}</li>
