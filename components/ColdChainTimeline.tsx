...
const steps = [
  ...
  },
  {
    ...
    labelEs: 'Empaque',
    labelEn: 'Packaging',
    subEs: 'Formatos IQF y Block',
    subEn: 'IQF and Block Formats',
    detailEs: 'Ofrecemos soluciones de empaque adaptadas a las especificaciones de cada cliente y mercado. Nuestros procesos aseguran una protección óptima.',
    detailEn: 'We offer packaging solutions adapted to the specifications of each client and market. Our processes ensure optimal protection.',
    color: '#22D3EE',
  },
  {
    icon: '🚢',
